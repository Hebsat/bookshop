    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <a class="Card-picture" href="/books/' + book.slug + '">' + '       <img src="' + book.image + '"/>\n' +
                    ...
                    (book.status === 'CART' ? ' <a class="Card-status" title="В корзине"><img src="/assets/img/icons/shopping-basket.svg" alt="В корзине">\n' : '') +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/genres/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/books/api/rateBookReview', data, function (result) {
            ...
            return {
                init: function () {
                                ...
                                if (result.result) {
                                    ...
                                    if ($cart.length) {
                                        ...
                                        if ($this.hasClass('Cart-buyAll')) {
                                            window.location.href = '/changeBookStatus/cart';
                                        }
                                    }
                                    if ($this.is('[data-btntype="check"]')) {
                                        shiftCheck($this);
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/api/rateBook', {
